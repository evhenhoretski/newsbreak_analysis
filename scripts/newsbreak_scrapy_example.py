"""
NOTE:
This script is a DEMO version for portfolio purposes.
Credentials and tokens were removed.
"""
...
def get_yesterday_metrics(page):
    ...
    try:
        #custom_date = datetime.strptime(yesterday_metrics.get("date"), "%Y-%m-%d").strftime("%d/%m/%y")1
...
def main():
    email = os.getenv("MSN_EMAIL")
    password = os.getenv("MSN_PASSWORD")
